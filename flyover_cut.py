# -*- coding: utf-8 -*-
"""
Created on Sun Jan  1 14:23:53 2017
...
plt.title('飞跃噪声（减推力）',fontproperties=myfont)
plot1=plt.plot(time[4],PNLT[4],'go',label='in point')
plot2=plt.plot(time[43],PNLT[43],'ro',label='out point')
plt.show()